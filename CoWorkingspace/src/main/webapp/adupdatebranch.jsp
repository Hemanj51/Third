<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.sql.*,com.space.db.*,com.space.query.*"%>
<!DOCTYPE html>
<html>
<head>
...
<div class="banner">
   ...
   <%
	...
	<form action="updatebranch" method="post" onsubmit="return mycss()">
		<table align="center" border="1">
			...
			<tr>
				...
				<td><input type="text" name="branchname"
					value="<%=rs.getString(2)%>" id="bname" class="form-control"/>
					<span id="branchname" class="text-danger font-weight-bold"></span></td>
			</tr>
			</div>
			<tr>
				<td>Location id</td>
				<td><input type="text" name="locationid" readonly="readonly"
					value="<%=rs.getInt(3)%>" class="form-control"/></td>
			</tr>
			<tr>
